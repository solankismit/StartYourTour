class delete_custom_requirement_model {
  int? code;
  String? status;
  String? message;
  Metadata? metadata;
  ...
  delete_custom_requirement_model(
      {this.code, this.status, this.message, this.metadata, this.data});

  delete_custom_requirement_model.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
